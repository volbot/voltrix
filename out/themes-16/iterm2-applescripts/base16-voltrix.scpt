...
tell application "iTerm2"
    tell current session of current window
        set background color to {2313, 2313, 4112}
        set foreground color to {65535, 65535, 65535}

        -- Set ANSI Colors
        set ANSI black color to {12336, 12336, 18761}
        ...
        set ANSI bright black color to {15934, 15934, 24415}
        ...
        set ANSI bright white color to {15934, 15934, 24415}
    end tell
end tell
