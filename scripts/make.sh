...
"base16")
    ...
    write () {
        ...
        echo "variant: \"dark\""
        echo "palette:"
        echo "base00: \"${BLACK_NORM:1}\""
        echo "base01: \"${RED_NORM:1}\""
        echo "base02: \"${GREEN_NORM:1}\""
        echo "base03: \"${YELLOW_NORM:1}\""
        echo "base04: \"${BLUE_NORM:1}\""
        echo "base05: \"${MAGENTA_NORM:1}\""
        echo "base06: \"${CYAN_NORM:1}\""
        echo "base07: \"${WHITE_NORM:1}\""
        echo "base08: \"${WHITE_DARK:1}\""
        echo "base09: \"${RED_BRIG:1}\""
        echo "base0A: \"${GREEN_BRIG:1}\""
        echo "base0B: \"${YELLOW_BRIG:1}\""
        echo "base0C: \"${BLUE_BRIG:1}\""
        echo "base0D: \"${MAGENTA_BRIG:1}\""
        echo "base0E: \"${CYAN_BRIG:1}\""
        echo "base0F: \"${WHITE_BRIG:1}\""
    }
;;
*)
